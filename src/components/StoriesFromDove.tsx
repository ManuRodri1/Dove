  ...
  return <section className="section home-stories" aria-labelledby="stories-heading">
    <div className="container">
      ...
      <div className="home-stories-layout">
        {visible.map((story, index) => <article className={`home-story ${index === 0 ? "home-story--lead" : "home-story--support"}`} key={story.id}>
          {story.image && story.href ? <Link className="home-story-media" href={story.href} tabIndex={-1} aria-hidden="true"><Image src={story.image.src} alt="" fill sizes={index === 0 ? "(min-width: 768px) 62vw, 100vw" : "(min-width: 768px) 18vw, 100vw"} style={{ objectFit: "cover" }} /></Link> : <div className="home-story-media home-story-media--empty" aria-hidden="true"><span>Dove</span></div>}
          <div className="home-story-copy">
            ...
            {story.href && <TextLink link={{ label: home.ui.readStory, href: story.href }} />}
          </div>
        </article>)}
      </div>
    </div>
