...
export const es: typeof en = {
  ...
  navigation: [{ label: "Nosotros", href: "" }, { label: "Qué hacemos", href: "" }, { label: "Participa", href: "" }, { label: "Nuestro impacto", href: "" }],
  ...
  impact: { eyebrow: "Una presencia que perdura", heading: "Con raíces en Puerto Plata", description: "Más de dos décadas construyendo vínculos, comunidad y posibilidades.", metrics: [{ value: "20+", label: "Años en Puerto Plata" }, { value: "—", label: "Jóvenes acompañados" }, { value: "—", label: "Estudiantes capacitados" }, { value: "—", label: "Jóvenes con empleo" }, { value: "—", label: "Familias apoyadas" }] },
  ...
  stories: { eyebrow: "Voces de nuestra comunidad", heading: "Historias de Dove", link: { label: "Ver todas las historias", href: "" }, pending: "Vista de desarrollo · Historia pendiente de migración", mediaPending: "Fotografía verificada pendiente" },
