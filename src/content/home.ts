...
export function getHome(locale: Locale) {
  ...
  const destinations = [links.ourStory(locale), links.whatWeDo(locale), links.volunteer.page(locale), links.section(locale, "impact")];
  ...
  return {
    ...
    stories: { ...copy.stories, link: { ...copy.stories.link, href: links.stories } },
